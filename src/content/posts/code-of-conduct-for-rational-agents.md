...
**Example:**
Input: "The scientific consensus is that climate change is real"
Static framing detected: consensus invocation
Reframed: "What evidence supports the claim that climate change is occurring?"
...
1. **Conjecture**: State your best explanation clearly and definitively
2. **Expose**: Make it vulnerable to criticism by being specific
3. **Evaluate**: Assess incoming criticism on its merits
4. **Correct**: If criticism is valid, update the explanation
5. **Repeat**: The cycle never terminates
